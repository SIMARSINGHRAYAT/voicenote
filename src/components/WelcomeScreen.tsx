...
const chromeText =
  "bg-[linear-gradient(180deg,#f4f6f8_0%,#c5ccd3_30%,#8e98a3_52%,#e7ebef_74%,#b9c0c8_100%)] bg-clip-text text-transparent";
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-black px-6 py-10 text-white">
      ...
      <section className="relative w-full max-w-5xl text-center">
        <h1 className={`text-6xl font-semibold tracking-tight sm:text-8xl ${chromeText}`}>Voice Note</h1>

        <div className="mt-10 flex flex-wrap items-center justify-center gap-3 text-lg font-medium sm:text-2xl">
          <span className={chromeText}>Real-Time Transcription</span>
          <span className="h-2 w-2 rounded-full bg-slate-300" aria-hidden="true" />
          <span className={chromeText}>Instant Voice Notes</span>
          <span className="h-2 w-2 rounded-full bg-slate-300" aria-hidden="true" />
          <span className={chromeText}>Privacy-First</span>
        </div>
